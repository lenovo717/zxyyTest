...
namespace zzyy.Db
{
    ...
    public sealed class DbUtility
    {
        ...
        public DbUtility(DbProviderType providerType)
        {
            ...
            ConnectionString = "user id=jhemr;password=jiahemk;initial catalog=chisdb_yyy;Server=192.168.151.108";
        ...
        public int ExecuteNonQueryByTrans(string sql, IList<DbParameter> parameters,DbCommand command)
        {
        ...
        public DbCommand CreateDbCommandByTrans(string sql, IList<DbParameter> parameters, CommandType commandType)
        {
